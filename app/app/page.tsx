    ...
    <section className="ui-section">
      <article className="ui-card space-y-2">
        ...
        <p className="text-sm text-slate-600">
          This is the authenticated app shell. Use Today to capture activities and events quickly.
        </p>
      ...
      <article className="ui-card space-y-2">
        ...
        <ul className="space-y-1 text-sm text-slate-600">
          ...
          <li>Authentication and data persistence will be wired in later tasks.</li>
        </ul>
      </article>
    </section>
  );
